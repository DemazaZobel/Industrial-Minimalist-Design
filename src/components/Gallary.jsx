...
const GalleryPage = () => {
  ...
  return (
    <section className="relative h-screen w-full px-8 py-24 bg-gradient-to-br from-primary/50 to-accent/50 overflow-hidden flex flex-col lg:flex-row items-center justify-between gap-14 lg:gap-28">

      {/* Text Side */}
      <div className="w-full lg:w-1/2 z-10 space-y-8 min-h-full flex flex-col justify-center ml-40">
        <h1 className="text-5xl lg:text-5xl font-extrabold text-gray-800 leading-tight">
      ...
      {/* Image Side */}
      <div className="relative w-full lg:w-1/2 h-full flex items-center justify-center z-10 mr-24 p-20">
        ...
        <div className="relative w-[400px] lg:w-[460px] h-full rounded-3xl overflow-hidden shadow-2xl border-[6px] border-white">
          {images.map((img, i) => (
            <img
              key={i}
              src={img}
